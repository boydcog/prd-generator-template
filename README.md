...
8. **스펙 템플릿 (v2.0)** — Product Spec·Design Spec·Tech Spec 책임 분리 구조. Product Spec이 IA·플로우·외부연동(EXT)의 단일 소스, Design Spec은 emocog 디자인 시스템 규칙(항목 1-11) 중심, Tech Spec은 LLM 최소 가드레일(항목 1-4) 중심
