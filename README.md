...
16. **출력물 검증 (`/verify`)** — 생성된 문서의 구조·스키마·인용·완전성을 자동 검증. debate/critique 파일(`{active_product}/agents/debate/`, `{active_product}/agents/critique.json`)을 포함한 모든 에이전트 산출물 경로를 검사
