...
- feat: 하드코딩된 조직/배포 변수를 `env.yml`로 추출 + label/reviewer 필수 규칙 추가 ([`840f247`](https://github.com/boydcog/prd-generator-template/commit/840f247))
- fix: worktree 정리 시 untracked 신규 파일 삭제 + PR 절차에 CHANGELOG 단계 추가 + CHANGELOG shortlink 형식 도입 ([`605b0ac`](https://github.com/boydcog/prd-generator-template/commit/605b0ac))
...
- Changelog 분리 + git pull rebase 복구 + sisyphus 제거 + worktree 후 main 복원 추가 ([`7be9cc3`](https://github.com/boydcog/prd-generator-template/commit/7be9cc3))
